...
class StatisticsContainer extends Component {
  ...
  componentWillMount() {
    this.props.actions.fetchStatsFields(this.props.stats.startDate, this.props.stats.endDate);
    this.props.actions.fetchStatsGraph(this.props.stats.startDate, this.props.stats.endDate);
  }
    ...
    return (
      <div className={styles.pizza}>
        <Card >
          ...
          <CardText>
            <div className={styles.pickerz}><h3>Období: </h3>
              <DatePicker
                label="Od"
                onChange={(val) => this.props.actions.changeDateRange('startDate', val)}
              ...
              <DatePicker
                label="Do"
                onChange={(val) => this.props.actions.changeDateRange('endDate', val)}
        ...
        <Card >
          ...
          <CardText>
            <LineChart
              width={800} height={500} data={this.props.stats.ordersGraph.toJS()}
            ...
            >
              ...
              <Legend />
              <Line
                name="Prodáno" type="monotone" dataKey="sold" stroke="#8884d8" activeDot={{ r: 8 }}
              />
            </LineChart>
          </CardText>
        </Card>
